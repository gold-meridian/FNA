...
public static class NumericsExtensions
{
	...
	extension(Matrix)
	{
		...
		{
			Matrix.Invert(matrix, out var inverted);
			return inverted;
		}
	}
	...
	extension(Vector3)
	{
		public static Vector3 Up => Vector3_Up;

		public static Vector3 Forward => Vector3_Forward;
	...
	extension(Rectangle)
	{
		...
		{
			result = Rectangle.Union(value1, value2);
		}
	}
